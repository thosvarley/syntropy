...
RDNXOR_DIST: dict[tuple[int, int, int], float] = {
    (0, 0, 0): 0.125,
    (0, 1, 1): 0.125,
    (1, 0, 1): 0.125,
    (1, 1, 0): 0.125,
...
# BIVARIATE_TEMPORAL_DYADIC: dict[
#     tuple[int, int, int, int], float
# ] = {  # System D — dyadic (b2' = a2)
#     (0, 0, 0, 0): 0.0625,
#     (0, 1, 0, 2): 0.0625,
#     (0, 2, 1, 0): 0.0625,
#     (0, 3, 1, 2): 0.0625,
...
# }
#
# BIVARIATE_TEMPORAL_TRIADIC: dict[
#     tuple[int, int, int, int], float
# ] = {  # System G — integrated (b2' = a2 XOR b2)
#     (0, 0, 0, 0): 0.0625,
#     (0, 1, 0, 3): 0.0625,
#     (0, 2, 1, 0): 0.0625,
#     (0, 3, 1, 3): 0.0625,
...
BIVARIATE_TEMPORAL_TRIADIC: dict[
    tuple[int, int, int, int], float
] = {  # b2' = a1 ^ b2   (parity — genuine synergy)
    (0, 0, 0, 0): 0.0625,
    (0, 1, 0, 3): 0.0625,
    (0, 2, 1, 0): 0.0625,
    (0, 3, 1, 3): 0.0625,
